...
/**
 * Checks if a MODP group name is valid.
 */
export const isValidGroup = (groupName: string): boolean => {
  return GROUPS[groupName.toLowerCase()] !== undefined;
};
